                        ...
                        <div class="col-md-11 coluna">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 pb-4 pt-2 pl-5">
                                    ...
                                    <form method="post" action="{{route('cliente.cargos.salvar',['id_departamento' => $departamento->id, 'id_cargo' => $cargo->id])}}">
                                        @csrf
                                        <input type="hidden" name="id" value="{{$cargo->id}}">
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                <label>Titulo do Cargo:</label>
                                                <input value="{{$cargo->titulo}}" type="text" class="form-control" name="titulo"
                                                       required/>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input value="{{$cargo->descricao_curta}}" type="text"
