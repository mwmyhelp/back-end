...
@section('conteudo')
            ...
            <div class="row">
                ...
                <div class="col-md-8 navegador d-flex">
                    ...
                    <li class="pr-3 pl-3 d-flex align-items-center ml-3 ativo">
                        <a href="#" class="font-weight-light">
                            <i class="fal fa-pencil mr-2"></i> Editar Normativa
                        </a>
                    </li>
                </div>
    ...
    <div class="page-inner pt-0">
            ...
            <form class="row" action="{{route('ceo.normativas.salvar',['id_normativa' => $normativa->id])}}" method="post">
                @csrf
                <div class="col-md-2 pt-3">
                    ...
                    <div class="text-muted mt-3">
                        ...
                        <div class="form-group">
                            <b>Geral:</b>
                            <br/>
                            <input @if($normativa->geral) checked @endif id="aplicar_geral" name="aplicar_geral" type="checkbox" value="true">
                            Aplicar essa normativa a todos os colaboradores.
                        </div>
                        <hr/>
                        <div class="form-group">
                            <b>Aplicar essa normativa para os seguintes departamentos:</b>
                                ...
                                <div class="p-2">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-10">
                                            <label>Título da Normativa:</label>
                                            <input value="{{$normativa->titulo}}" type="text" name="titulo" class="form-control" required/>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-10">
                                            <label>Descrição da Normativa:</label>
                                            <textarea rows="10" name="html" id="editor_01" class="form-control"
                                                      required>{!! $normativa->html !!}</textarea>
                                        </div>
                                    </div>
                                    <div class="row">
